class ServerHelpers():
    ...
    def signIn(message, clientSock, clientDict):
        ...
        # Create new user with input username
            ...
            thisUser = ServerHelpers.addUser(username, clientSock, clientDict)
            # Handle collisions
            if thisUser == -1:
                return -5
    ...
    def sendMsg(message, clientSock, clientDict):
        sender = ServerHelpers.getClientUsername(clientSock, clientDict)
        recipient = message[1]
        ...
        try:
            ...
            # bool to false
                ...
                ServerHelpers.enqueueMsg(payload, recipient, clientDict)
            try:
    ...
    def deleteAcct(clientSock, clientDict):
        toDelete = ServerHelpers.getClientUsername(clientSock, clientDict)
        clientDict.pop(toDelete)
        return toDelete

    def logOut(clientSock, clientDict):
        toLogOut = ServerHelpers.getClientUsername(clientSock, clientDict)
